...
public class BaiduPush {
    ...
    public final static String mUrl = "http://api.tuisong.baidu.com/rest/3.0/push/single_device";// 基础url
     ...
     * 构造函数
     * 
     * @param http_mehtod 请求方式
     * @param secret_key 安全key
     * @param api_key 应用key
     */
    ...
    public String PostHttpRequest(RestApi data) {
        ...
        HttpRequest(mUrl, sb.toString(), response);
    ...
    private int HttpRequest(String url, String query, StringBuilder out) {
        ...
        try {
            ...
            connection
                    .setRequestProperty(
                            "User-Agent",
                            "BCCS_SDK/3.0 (Darwin; Darwin Kernel Version 14.0.0: Fri Sep 19 00:26:44 PDT 2014; root:xnu-2782.1.97~2/RELEASE_X86_64; x86_64) PHP/5.6.3 (Baidu Push Server SDK V3.0.0 and so on..) cli/Unknown ZEND/2.6.0");
    ...
    public String PushMessage(String message, String userid) {
        ...
        ra.put(RestApi._APIKEY, PushApplication.API_KEY);
        ra.put(RestApi._CHANNEL_ID, userid);
        ra.put(RestApi._SINGLE_MESSAGES, message);
        // Unix时间戳：是从1970年1月1日（UTC/GMT的午夜）开始所经过的秒数
        ra.put(RestApi._TIMESTAMP, Long.toString(System.currentTimeMillis() / 1000));
        return PostHttpRequest(ra);
    }
